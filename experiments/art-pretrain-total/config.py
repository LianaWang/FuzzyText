...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='ArTDataset',
            ann_file=
            '../../data/ArT/ImageSets/Main/train_totaltest_exclude.txt',
            img_prefix='../../data/ArT/',
    ...
    val=dict(
        type='ArTDataset',
        ann_file='../../data/ArT/ImageSets/Main/short.txt',
        img_prefix='../../data/ArT/',
        cache_root='Cache_contour',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        samples_per_gpu=4,
        type='ArTDataset',
        ann_file='../../data/ArT/ImageSets/Main/test.txt',
        img_prefix='../../data/ArT/',
        cache_root='Cache_contour',
        test_mode=True,
        pipeline=[
...
optimizer = dict(type='SGD', lr=0.002, momentum=0.99, weight_decay=0.0005)
...
evaluation = dict(
    interval=600,
    proposal_thr_list=[
        0.7, 0.73, 0.74, 0.75, 0.76, 0.81, 0.82, 0.83, 0.84, 0.85, 0.86
    ])
